...
import com.linguagens.domain.exceptions.EntidadeEmUsoException;
import com.linguagens.domain.exceptions.EntidadeNaoEncontradaException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex,
		...
		ProblemType problemType = ProblemType.TAMANHO_MAX_UPLOAD_EXCEDIDO;
		
		String detail = String.format("O tamanho máximo da imagem para upload foi excecido.");
